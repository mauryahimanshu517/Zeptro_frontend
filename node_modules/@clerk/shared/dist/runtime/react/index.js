const require_chunk = require('../chunk-C_dlxeql.js');
...
const require_error = require('../error-B8rjBHwB.js');
require('../noop-Bi5xtB31.js');
const require_createDeferredPromise = require('../createDeferredPromise-qVNWqG9g.js');
require('../underscore-C7r5Yoz7.js');
const require_organization = require('../organization-CdNRqdLj.js');
const require_telemetry = require('../telemetry-6CzUREWH.js');
const react = require_chunk.__toESM(require("react"));
const react_jsx_runtime = require_chunk.__toESM(require("react/jsx-runtime"));
const swr = require_chunk.__toESM(require("swr"));
const swr_infinite = require_chunk.__toESM(require("swr/infinite"));
const dequal = require_chunk.__toESM(require("dequal"));
const swr_mutation = require_chunk.__toESM(require("swr/mutation"));
...
require_chunk.__export(clerk_swr_exports, {
	useSWR: () => swr.default,
	useSWRInfinite: () => swr_infinite.default
});
require_chunk.__reExport(clerk_swr_exports, require("swr"));
...
const __experimental_CheckoutProvider = ({ children,...rest }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CheckoutContext.Provider, {
		value: { value: rest },
		children
	});
};
...
const OrganizationProvider = ({ children, organization, swrConfig }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(clerk_swr_exports.SWRConfig, {
		value: swrConfig,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OrganizationContextInternal.Provider, {
...
function useAssertWrappedByClerkProvider(displayNameOrFn) {
	const ctx = react.default.useContext(ClerkInstanceContext);
	if (!ctx) {
...
const usePagesOrInfinite = (params, fetcher, config, cacheKeys) => {
	const [paginatedPage, setPaginatedPage] = (0, react.useState)(params.initialPage ?? 1);
	const initialPageRef = (0, react.useRef)(params.initialPage ?? 1);
	const pageSizeRef = (0, react.useRef)(params.pageSize ?? 10);
	...
	const { data: swrData, isValidating: swrIsValidating, isLoading: swrIsLoading, error: swrError, mutate: swrMutate } = (0, swr.default)(swrKey, swrFetcher, {
		keepPreviousData,
		...cachingSWROptions
	});
...
function useOrganization(params) {
	...
	const domains = usePagesOrInfinite({ ...domainParams }, organization?.getDomains, {
	...
	const membershipRequests = usePagesOrInfinite({ ...membershipRequestParams }, organization?.getMembershipRequests, {
	...
	const invitations = usePagesOrInfinite({ ...invitationsParams }, organization?.getInvitations, {
...
function useOrganizationList(params) {
	...
	const invitations = usePagesOrInfinite({ ...userInvitationsParams }, user?.getOrganizationInvitations, {
	...
	const suggestions = usePagesOrInfinite({ ...userSuggestionsParams }, user?.getOrganizationSuggestions, {
...
function useUser() {
	...
	const user = useUserContext();
	const clerk = useClerkInstanceContext();
	clerk.telemetry?.record(require_telemetry.eventMethodCalled(hookName$1));
...
const useSubscription = (params) => {
	...
	const swr$1 = (0, swr.default)(billingEnabled ? {
	...
	const revalidate = (0, react.useCallback)(() => swr$1.mutate(), [swr$1.mutate]);
	return {
		data: swr$1.data,
		error: swr$1.error,
...
const useCheckout = (options) => {
	...
	const properties = (0, react.useMemo)(() => {
...
const Elements = ({ stripe: rawStripeProp, options, children }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ElementsContext.Provider, {
		value: ctx,
		children
	});
};
const useElementsContextWithUseCase = (useCaseMessage) => {
	const ctx = react.default.useContext(ElementsContext);
...
const useElementsOrCheckoutSdkContextWithUseCase = (useCaseString) => {
	const elementsContext = react.default.useContext(ElementsContext);
...
const createElementComponent = (type, isServer$1) => {
	...
	const ClientElement = ({ id, className, fallback, options = {}, onBlur, onFocus, onReady, onChange, onEscape, onClick, onLoadError, onLoaderStart, onNetworksChange, onConfirm, onCancel, onShippingAddressChange, onShippingRateChange }) => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [!isReady && fallback, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			id,
			style: {
...
const StripeLibsProvider = ({ children }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StripeLibsContext.Provider, {
		value: { value: stripeClerkLibs || null },
		children
	});
};
...
const ValidateStripeUtils = ({ children }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StripeUtilsContext.Provider, {
		value: { value: {
			stripe,
			elements
		} },
...
const PropsProvider = ({ children,...props }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PaymentElementContext.Provider, {
		value: { value: {
			...props,
			...utils,
...
const PaymentElementProvider = ({ children,...props }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StripeLibsProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PropsProvider, {
		...props,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PaymentElementInternalRoot, { children })
	}) });
};
const PaymentElementInternalRoot = (props) => {
	const { stripe, externalClientSecret, stripeAppearance } = usePaymentElementContext();
	const locale = useLocalization();
	if (stripe && externalClientSecret) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Elements, {
		stripe,
		options: {
			loader: "never",
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ValidateStripeUtils, { children: props.children })
	}, externalClientSecret);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DummyStripeUtils, { children: props.children });
};
const PaymentElement = ({ fallback }) => {
	...
	if (!stripe || !externalClientSecret) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: fallback });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PaymentElement$1, {
		fallback,
		onReady,
		options
	});
